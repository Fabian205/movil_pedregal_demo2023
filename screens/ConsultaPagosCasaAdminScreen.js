...
const ConsultaPagosCasaAdminScreen = (props) => {
  ...
  useEffect(() => {
    fetch("https://nobasys.com/demo/getDatosCasaAdmindemo.php", {
    //fetch("https://nobasys.com/api/getDatosCasaAdmin.php", {
      //fetch("http://10.0.2.2:80/api/getDatosCasaAdmin.php", {
        ...
        .then((responseJson) => {
          if(responseJson=="La casa no existe"){
            alert("La casa no existe, o no existen datos para mostrar, regrese y vuelva a intentar!");
          }else{
