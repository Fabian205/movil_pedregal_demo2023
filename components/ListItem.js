...
const ListItem = ({ item }) => {
  ...
  return (
    <View style={[styles.container, {backgroundColor:theme.background}]}>
      ...
      <View style={styles.flex}>
        <Text style={[styles.text3, {paddingRight: Platform.OS === 'ios' ? 60 : 58 }]}>Teléfono:</Text>
        <Text style={[styles.text2, {color: theme.color}]}>{TELEFONOS}</Text>
      </View>
      <View style={styles.flex}>
        <Text style={[styles.text3, {paddingRight: Platform.OS === 'ios' ? 82 : 83 }]}>Email:</Text>
        <Text style={[styles.text2, {color: theme.color}]}>{EMAIL}</Text>
      </View>
      <View style={styles.flex}>
        <Text style={[styles.text3, {paddingRight: Platform.OS === 'ios' ? 30 : 32 }]}>Habitado por:</Text>
